...
namespace Lykke.Signing.Api
{
    ...
    public partial interface ILykkeSigningAPI : System.IDisposable
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<PubKeyResponse>> ApiBitcoinNextaddressPostWithHttpMessagesAsync(NextAddressRequest model = default(NextAddressRequest), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<GetAllWalletsResponse>> ApiBitcoinAddressesGetWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
