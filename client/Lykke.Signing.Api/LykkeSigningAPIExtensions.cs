...
namespace Lykke.Signing.Api
{
    ...
    public static partial class LykkeSigningAPIExtensions
    {
            ...
            /// <param name='model'>
            /// </param>
            public static PubKeyResponse ApiBitcoinNextaddressPost(this ILykkeSigningAPI operations, NextAddressRequest model = default(NextAddressRequest))
            {
                return operations.ApiBitcoinNextaddressPostAsync(model).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PubKeyResponse> ApiBitcoinNextaddressPostAsync(this ILykkeSigningAPI operations, NextAddressRequest model = default(NextAddressRequest), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApiBitcoinNextaddressPostWithHttpMessagesAsync(model, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The operations group for this extension method.
            /// </param>
            public static GetAllWalletsResponse ApiBitcoinAddressesGet(this ILykkeSigningAPI operations)
            {
                return operations.ApiBitcoinAddressesGetAsync().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<GetAllWalletsResponse> ApiBitcoinAddressesGetAsync(this ILykkeSigningAPI operations, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ApiBitcoinAddressesGetWithHttpMessagesAsync(null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
